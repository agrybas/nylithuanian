...
urlpatterns = patterns('',
    ...
    url(r'^(?P<active_tab>nuotraukos)/', include('photos.urls')),
...
urlpatterns += patterns('',
    ...
    url(r'^apie-mus/apie-jav-lb/$', TemplateView.as_view(template_name='flatpages/apie_jav_lb.html'), { 'active_tab': 'apie-mus' }),
