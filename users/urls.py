...
#    url(r'^mano-saskaita/$', SiteUserPersonalView.as_view()),
    ...
    url(r'^(?P<slug>\S+)/keisti-slaptazodi/$', login_required(login_url='/nariai/prisijungti')(SiteUserChangePasswordView.as_view())),
    url(r'^(?P<slug>\S+)/redaguoti/$', login_required(login_url='/nariai/prisijungti')(SiteUserUpdateView.as_view())),
