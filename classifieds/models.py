...
class Classified(models.Model):
    ...
    create_date = models.DateTimeField(null=False, auto_now_add=True, verbose_name='Skelbimo įkėlimo data', help_text='Prašome datą įvesti formatu "yyyy-mm-dd hh:mm"')
    modify_date = models.DateTimeField(null=False, auto_now=True, verbose_name='Skelbimo paskutinio redagavimo data', help_text='Prašome datą įvesti formatu "yyyy-mm-dd hh:mm"')
    ...
    def get_absolute_url(self):
        return settings.SITE_URL + '/skelbimai/{0}'.format(self.id)
