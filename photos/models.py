...
class Photo(models.Model):
    ...
    user = models.ForeignKey(User, blank=False, null=False, editable=False)  # user who created the gallery
    gallery = models.ForeignKey(Gallery, blank=False, null=False)  # TODO add limit_choices_to argument to restrict galleries to only those created by current user
