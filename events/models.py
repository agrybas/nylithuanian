...
class Event(models.Model):
    ...
    start_date = models.DateTimeField(verbose_name='Renginio pradžia', help_text='Prašome datą įvesti formatu "mm/dd/yyyy hh:mm"')
    end_date = models.DateTimeField(verbose_name='Renginio pabaiga', help_text='Prašome datą įvesti formatu "mm/dd/yyyy hh:mm"', null = True, blank = True)
